...
糸の締結に時間と練度を必要とすることや，度々空気漏れを生じるという難点があった．そこ
...
\noindent で本研究では端部部品を改良し，ゴムと端部を接着剤で，スリーブと端部をOリングと接着剤でそれぞれ固定する方式へと変更した(図\ref{fig:OringMPA}下)．
これにより細径MPAに練度が不要となり，作成時間も大幅に短縮された．
